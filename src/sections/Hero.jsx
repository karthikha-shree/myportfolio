...
{/* ALL BUTTONS TOGETHER */}
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <a
            href="#projects"
            className="px-6 py-3 rounded-xl bg-midnight-primary dark:bg-retro-primary text-white font-semibold hover:scale-105 transition-all"
          >
            View Projects
          </a>
          ...
          <a
            href="#contact"
            className="px-6 py-3 rounded-xl bg-midnight-secondary dark:bg-retro-secondary text-white font-semibold hover:scale-105 transition-all"
          >
            Contact Me
          </a>
